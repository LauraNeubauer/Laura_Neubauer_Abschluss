    ...
    fun attackEnemy(enemy: Enemy, attacke: AttacksHeros, dead: MutableList<Enemy>, inFight: MutableList<Enemy>) {
        if (attacke.damage!! > enemy.lp) {
            ...
            if (remainingArmorPercent in 90..100) {
                ...
                println("${enemy.name} verliert ${attacke.damage} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
                println()
                ...
                println("${this.name} hat ${attacke.name} angewand!")
                println("${enemy.name} verliert ${attacke.damage} Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
                println()
            }
        }
    }
