open class Hero(
    ...
    var speed: Int,
    var weakness: String,
    var attacke1 : Attacke,
) {
    fun attackEnemy(enemy: Enemy, attacke : Attacke) {
        if (attacke.schaden > enemy.lp) {
            enemy.lp = 0
            ...
            if (remainingArmorPercent in 90..100) {
                var realDamage = (attacke.schaden / 100) * 10
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            } else if (remainingArmorPercent in 80..90) {
                var realDamage = (attacke.schaden / 100) * 20
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            } else if (remainingArmorPercent in 70..80) {
                var realDamage = (attacke.schaden / 100) * 30
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            } else if (remainingArmorPercent in 60..70) {
                var realDamage = (attacke.schaden / 100) * 40
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            } else if (remainingArmorPercent in 50..60) {
                var realDamage = (attacke.schaden / 100) * 50
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            } else if (remainingArmorPercent in 40..50) {
                var realDamage = (attacke.schaden / 100) * 60
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            } else if (remainingArmorPercent in 30..40) {
                var realDamage = (attacke.schaden / 100) * 70
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            } else if (remainingArmorPercent in 20..30) {
                var realDamage = (attacke.schaden / 100) * 80
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            } else if (remainingArmorPercent in 10..20) {
                var realDamage = (attacke.schaden / 100) * 90
                enemy.armorReduction -= attacke.schaden
                enemy.lp -= realDamage
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Rüstungspunkte und $realDamage Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
                ...
                enemy.armor = 0
                enemy.lp -= attacke.schaden
                println("${this.name} hat $attacke1 angewand!")
                println("${enemy.name} verliert ${attacke.schaden} Lebenspunkte und hat noch ${enemy.lp} Lebenspunkte!")
            }
        }
    }
}
